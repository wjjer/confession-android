...
public class FileUploadUtil {
    ...
    public static final String TAG = FileUploadUtil.class.getName();
...
//            public void run() {
                ...
                try {
                    ...
                    if (file != null) {
                        ...
                        result = sb1.toString();
                        FileUploadUtil.result = new String(result.getBytes("iso-8859-1"),"utf-8");
                        Log.i(TAG, "result : " + FileUploadUtil.result);
                            input.close();
                        }
                        else{
...
//        });
//        thread.start();
        Log.i(TAG, "---"+FileUploadUtil.result+"---");
        return  FileUploadUtil.result;
    }
